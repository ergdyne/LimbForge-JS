...
export default class Users extends React.Component {
  ...
  render() {
    ...
    const userInputs = [
      { accessor: `email`, name: `Email`, type: `string`, inputType: `text` },
      { accessor: `groupName`, name: `Group`, type: `string`, inputType: `select`, placeholder: 'Select Group', options: this.props.groupOptions },
      { accessor: `userGroupAccess`, name: `Permission`, type: `string`, inputType: `select`,  placeholder: 'Select Access', options: userAccessLevels.slice(0, 2) }
    ]
    return (
